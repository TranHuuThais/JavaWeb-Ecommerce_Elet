<%-- 
    Document   : footer
    Created on : Sep 13, 2024, 1:40:26 PM
    Author     : ACER
--%>
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="CreateUserServlet" class="dropdown-item">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="CreateCategoryServlet" class="dropdown-item">
                        <i class="fa fa-plus me-2"></i>Add
                    </a>
                </div>
            </div>
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="CreateProductServlet" class="dropdown-item">
                        <i class="fa fa-plus me-2"></i>Add
                    </a>
                </div>
            </div>
