<%-- 
    Document   : edit
    Created on : Sep 14, 2024, 11:13:27 AM
    Author     : ACER
--%>
                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="EditCategoryServlet" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="name" type="text" value="${category.name}" class="form-control" id="categoryName">
                                    </div>
                                    <div class="mb-3">
                                        <label for="categoryName" class="form-label">Thumbnail</label>
                                        <input name="thumbnail" type="text" value="${category.thumbnail}" class="form-control" id="categoryName">
                                    </div>
