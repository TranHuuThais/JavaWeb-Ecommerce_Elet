<%-- 
    Document   : category
    Created on : Sep 20, 2024, 10:38:09 AM
    Author     : ACER
--%>
    ...
    <div id="wrapper">
        ...
        <section class="flat-spacing-2">
            <div class="container">
               ...
               <section id="pagination" class="tf-pagination-wrap tf-pagination-list">
    <c:forEach var="i" begin="1" end="${totalPages}">
        <li class="<c:if test='${i == currentPage}'>active</c:if>">
            <!-- Thêm categoryId vào URL -->
            <a class="pagination-link" href="CategoryServlet?categoryId=${category.id}&page=${i}">${i}</a>
        </li>
    </c:forEach>
    <li>
        <!-- Thêm categoryId vào URL cho liên kết next page -->
        <a href="CategoryServlet?categoryId=${category.id}&page=${currentPage + 1}" class="pagination-link animate-hover-btn <c:if test='${currentPage == totalPages}'>disabled</c:if>">
                            ...
                            <div class="tf-mini-cart-tool-content">
                                ...
                                <div class="field">
                                    ...
                                    <select class="tf-select w-100" id="ShippingCountry_CartDrawer-Form" name="address[country]" data-default="">
                                        ...
                                        <option value="Japan" data-provinces="[['Aichi','Aichi'],['Akita','Akita'],['Aomori','Aomori'],['Chiba','Chiba'],['Ehime','Ehime'],['Fukui','Fukui'],['Fukuoka','Fukuoka'],['Fukushima','Fukushima'],['Gifu','Gifu'],['Gunma','Gunma'],['Hiroshima','Hiroshima'],['Hokkaid?','Hokkaido'],['Hy?go','Hyogo'],['Ibaraki','Ibaraki'],['Ishikawa','Ishikawa'],['Iwate','Iwate'],['Kagawa','Kagawa'],['Kagoshima','Kagoshima'],['Kanagawa','Kanagawa'],['Kumamoto','Kumamoto'],['Ky?to','Kyoto'],['K?chi','Kochi'],['Mie','Mie'],['Miyagi','Miyagi'],['Miyazaki','Miyazaki'],['Nagano','Nagano'],['Nagasaki','Nagasaki'],['Nara','Nara'],['Niigata','Niigata'],['Okayama','Okayama'],['Okinawa','Okinawa'],['Saga','Saga'],['Saitama','Saitama'],['Shiga','Shiga'],['Shimane','Shimane'],['Shizuoka','Shizuoka'],['Tochigi','Tochigi'],['Tokushima','Tokushima'],['Tottori','Tottori'],['Toyama','Toyama'],['T?ky?','Tokyo'],['Wakayama','Wakayama'],['Yamagata','Yamagata'],['Yamaguchi','Yamaguchi'],['Yamanashi','Yamanashi'],['?ita','Oita'],['?saka','Osaka']]">Japan</option>
                                        <option value="Malaysia" data-provinces="[['Johor','Johor'],['Kedah','Kedah'],['Kelantan','Kelantan'],['Kuala Lumpur','Kuala Lumpur'],['Labuan','Labuan'],['Melaka','Malacca'],['Negeri Sembilan','Negeri Sembilan'],['Pahang','Pahang'],['Penang','Penang'],['Perak','Perak'],['Perlis','Perlis'],['Putrajaya','Putrajaya'],['Sabah','Sabah'],['Sarawak','Sarawak'],['Selangor','Selangor'],['Terengganu','Terengganu']]">Malaysia</option>
                                        <option value="Netherlands" data-provinces="[]">Netherlands</option>
                                        <option value="New Zealand" data-provinces="[['Auckland','Auckland'],['Bay of Plenty','Bay of Plenty'],['Canterbury','Canterbury'],['Chatham Islands','Chatham Islands'],['Gisborne','Gisborne'],['Hawke's Bay','Hawke?s Bay'],['Manawatu-Wanganui','Manawat?-Whanganui'],['Marlborough','Marlborough'],['Nelson','Nelson'],['Northland','Northland'],['Otago','Otago'],['Southland','Southland'],['Taranaki','Taranaki'],['Tasman','Tasman'],['Waikato','Waikato'],['Wellington','Wellington'],['West Coast','West Coast']]">New Zealand</option>
